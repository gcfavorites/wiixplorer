...
static inline void srown(byte * src, byte * dst, int w, int denom, int n)
{
...
static inline void srowc(byte * src, byte * dst, int w, int denom, int n)
{
	int invdenom = (1<<16) / denom;
	int x, left;
	unsigned sum1 = 0;
...
static inline void scoln(byte * src, byte * dst, int w, int denom, int n)
{
	int invdenom = (1<<16) / denom;
	int x, y, k;
	byte *s;
