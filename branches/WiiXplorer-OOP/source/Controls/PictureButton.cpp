...
PictureButton::PictureButton(const u8 *img)
	: GuiButton(0, 0)
{
	Init(img, NULL, NULL, NULL);
}

PictureButton::PictureButton(const u8 *img, const u8 *imgOver)
	: GuiButton(0, 0)
{
	Init(img, imgOver, NULL, NULL);
}

PictureButton::PictureButton(const u8 *img, const u8 *imgOver, GuiSound * sndClick)
	: GuiButton(0, 0)
{
	Init(img, imgOver, sndClick, NULL);
}

PictureButton::PictureButton(const u8 *img, const u8 *imgOver, GuiSound * sndClick, GuiSound * sndOver)
	: GuiButton(0, 0)
{
...
void PictureButton::Init(const u8 *img, const u8 *imgOver, GuiSound * sndClick, GuiSound * sndOver)
{
	imgData = new GuiImageData(img);
	imgOverData = imgOver ? new GuiImageData(imgOver) : NULL;
