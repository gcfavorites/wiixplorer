...
{
	public:
		PictureButton(const u8 *img);
		PictureButton(const u8 *img, const u8 *imgOver);
		PictureButton(const u8 *img, const u8 *imgOver, GuiSound * sndClick);
		PictureButton(const u8 *img, const u8 *imgOver, GuiSound * sndClick, GuiSound * sndOver);
		...
		~PictureButton();
	private:
		void Init(const u8 *img, const u8 *imgOver, GuiSound * sndClick, GuiSound * sndOver);
