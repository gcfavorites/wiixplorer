...
namespace nsFTP
{
   ...
   public:
      CLogonInfo();
      CLogonInfo(const tstring& strHostname, unsigned int ushHostport=DEFAULT_FTP_PORT, const tstring& strUsername=ANONYMOUS_USER, 
                 const tstring& strPassword=_T("anonymous@user.com"), unsigned int feat=1, const tstring& strAccount=_T(""));
      CLogonInfo(const tstring& strHostname, unsigned int ushHostport, const tstring& strUsername, const tstring& strPassword,
		 unsigned int feat, 
      ...
      void SetHost(const tstring& strHostname, unsigned int ushHostport=DEFAULT_FTP_PORT, const tstring& strUsername=ANONYMOUS_USER, 
      ...
      unsigned int               Hostport()   const  { return m_ushHostport;    }
      ...
      unsigned int               FwPort()     const  { return m_ushFwPort;      }
      const CFirewallType& FwType()     const  { return m_FwType;         }
      unsigned int         Feat()       const       { return m_feat;           }
   
   private:
      tstring        m_strHostname;   ///< name or ip-address of the ftp-server
      unsigned int         m_ushHostport;   ///< port of the ftp-server
      ...
      unsigned int         m_ushFwPort;     ///< port of the firewall
      CFirewallType  m_FwType;        ///< type of firewall
      unsigned int   m_feat;          /// enable or not feat 	
   };
