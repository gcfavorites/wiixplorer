...
// #include <libtga/tgaconfig.h>  /* include our config header before anything else */
#include <stdio.h>
#include <string.h>
...
TGA* TGAOpenMem __P((const unsigned char *img, int imgSize));
...
int TGADecodeTo4x4RGB8 __P((TGA *tga, TGAData *tgaData, unsigned char *dst));
